...
public class Acara34_2 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static final double CIRCLE_LONG = 113.7227; // Longitude of circle center
    private static final float CIRCLE_RADIUS = 250; // Radius of circle in meters
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (location != null) {
                    ...
                    double radiusInMeters = 250; // Change this value to set the desired radius in meters
